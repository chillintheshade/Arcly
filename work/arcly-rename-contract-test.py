...
PBXPROJ = ROOT / "Arcly.xcodeproj" / "project.pbxproj"
...
def main() -> None:
    ...
    app_requirements = [
        ('Loc.string("menu.show")', "menu show command is localized"),
        ('Loc.string("onboarding.title")', "onboarding title is localized"),
        ('Loc.string("menu.quit")', "quit menu item is localized"),
        ...
        ('window.title = Loc.string("settings.windowTitle")', "settings window title is localized"),
    ]
    ...
    for old in [
        ...
        forbid(app, old, "hard-coded localized app string")

    project_requirements = [
        ("name: Arcly", "generated project name"),
        ("Arcly:", "generated target name"),
    ...
    for old in ["PieMenu", "Orbis"]:
        forbid(combined_docs, old, "old app name in public documentation")
